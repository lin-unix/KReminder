...
**
** Created: Wed Jun 1 20:44:04 2011
...
static const char qt_meta_stringdata_IntroWindow[] = {
    "IntroWindow\0"
};

const QMetaObject IntroWindow::staticMetaObject = {
    { &KXmlGuiWindow::staticMetaObject, qt_meta_stringdata_IntroWindow,
      qt_meta_data_IntroWindow, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &IntroWindow::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_IntroWindow))
